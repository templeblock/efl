...
my_efl_ui_text_bt_6(void *data, Evas_Object *obj EINA_UNUSED, void *event_info EINA_UNUSED)
{
   ...
   Efl_Text_Wrap wrap = efl_text_wrap_get(text_obj);

   switch(wrap)
     {
      case EFL_TEXT_WRAP_NONE:
         wrap = EFL_TEXT_WRAP_CHAR;
         break;
      case EFL_TEXT_WRAP_CHAR:
         wrap = EFL_TEXT_WRAP_WORD;
         break;
      case EFL_TEXT_WRAP_WORD:
         wrap = EFL_TEXT_WRAP_MIXED;
         break;
      case EFL_TEXT_WRAP_MIXED:
         wrap = EFL_TEXT_WRAP_NONE;
         break;
      default:
         break;
     }
